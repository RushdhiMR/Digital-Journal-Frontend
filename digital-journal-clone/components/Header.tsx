...
export default function Header() {
  ...
  return (
    <header className="relative w-full bg-white text-gray-900 z-50 font-sans border-b border-gray-200">
      ...
      <div className="max-w-[1400px] mx-auto pl-10 sm:pl-16 pr-4 md:pr-6 py-2.5 sm:py-4 flex items-center justify-between gap-1.5 sm:gap-4 max-w-full overflow-hidden">
        
        {/* LOGO & SUBTITLE */}
        <Link href="/" className="flex items-center gap-2 sm:gap-3 group flex-shrink min-w-0 -ml-8 sm:-ml-12">
