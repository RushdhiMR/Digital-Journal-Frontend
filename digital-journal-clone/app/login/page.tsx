    ...
    <div className="min-h-screen bg-white flex flex-col font-sans text-gray-900">
      ...
      <main className="flex-1 py-12 lg:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* LEFT COLUMN: EDITORIAL BRANDING & MEMBER BENEFITS */}
          <div className="lg:col-span-6 space-y-6">
            <div className="flex items-center gap-3 text-xs font-bold text-[#BF1E2D] uppercase tracking-wider">
              ...
              <span>DIGITAL JOURNAL MEMBER ACCESS</span>
            </div>

            <h1 className="text-3xl sm:text-4xl lg:text-[42px] font-bold text-gray-900 leading-[1.15] font-serif">
              Welcome back to Digital Journal
            </h1>

            <p className="text-gray-600 text-base leading-relaxed font-sans">
              Sign in to your account to access real-time business news, executive market watch dashboards, author publishing tools, and personalized reading feeds.
            </p>

            {/* Feature Highlights */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="p-4 bg-gray-50 border border-gray-100 rounded-none space-y-1.5">
                <ShieldCheck className="w-5 h-5 text-[#BF1E2D]" />
                <h3 className="font-bold text-sm text-gray-900">Cybersecurity & Tech</h3>
                <p className="text-xs text-gray-500">Real-time enterprise breach analysis and AI technology coverage.</p>
              </div>

              <div className="p-4 bg-gray-50 border border-gray-100 rounded-none space-y-1.5">
                <TrendingUp className="w-5 h-5 text-[#BF1E2D]" />
                <h3 className="font-bold text-sm text-gray-900">Executive Markets</h3>
                <p className="text-xs text-gray-500">Stock indicators, economic forecasts, and corporate press releases.</p>
              </div>

              <div className="p-4 bg-gray-50 border border-gray-100 rounded-none space-y-1.5">
                <Edit3 className="w-5 h-5 text-[#BF1E2D]" />
                <h3 className="font-bold text-sm text-gray-900">Journalist Hub</h3>
                <p className="text-xs text-gray-500">Editorial article submissions and author analytics suite.</p>
              </div>

              <div className="p-4 bg-gray-50 border border-gray-100 rounded-none space-y-1.5">
                <Lock className="w-5 h-5 text-[#BF1E2D]" />
                <h3 className="font-bold text-sm text-gray-900">Secure Access</h3>
                <p className="text-xs text-gray-500">Universal OAuth and multi-role administrator verification.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 bg-white p-0 sm:p-2">
            ...
            {/* Title */}
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 font-serif">Sign In to Your Account</h2>
